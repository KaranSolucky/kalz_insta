...
import 'package:kalz_studio/models/user.dart';
import 'package:kalz_studio/models/comment.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<Widget> getUserStories() {
    List<Widget> stories = [];
    for (User1 follower in user.following) {
      stories.add(getStory(follower));
    }
    return stories;
  }

  Widget getStory(User1 follower) {
    return Container(
  ...
  Widget getLikes(List<User1> likes) {
    List<Widget> likers = [];
    for (User1 follower in likes) {
